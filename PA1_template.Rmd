...
daterange <- c(seq(from = mindate, to = maxdate, by = 6))
```
...
hist(steps.a.day1$steps1000, main = "Total Step Each Day", xlab = "Date",
            ylab = "Total Steps (000s)", ylim = range(c(0,25)))
qplot(steps.a.day1$steps1000, geom = "histogram", binwidth = 0.1, xlab = "Date",
                  ylab = "Total Steps (000s)", xlim = as.Date(daterange), ylim = c(0,25))
ggplot(data = steps.a.day1, aes(steps.a.day1$date)) +
